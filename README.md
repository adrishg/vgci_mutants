...
The ensembles analyzed here are generated by selectively masking user-defined columns of an
AlphaFold2/ColabFold multiple sequence alignment while retaining the remaining evolutionary context.
This repository is the downstream validation layer: it asks whether the resulting structural
variability is localized, reproducible, physically plausible, and compatible with known channel
structures.
...
## Targeted masking repository

The workflow used to generate the targeted-masked prediction ensembles is available at
[adrishg/targetedMasking](https://github.com/adrishg/targetedMasking).
