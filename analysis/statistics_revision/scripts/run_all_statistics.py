...
def main() -> None:
    ...
    repo=args.repo_root.resolve(); output=(repo/args.output_dir).resolve() if not args.output_dir.is_absolute() else args.output_dir; [ (output/name).mkdir(parents=True,exist_ok=True) for name in ("scripts","tables","figures","logs") ]
