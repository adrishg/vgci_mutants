...
from cav12_ensemble_rmsf.workflow import align_manifest_shard

def main() -> None:
    parser = argparse.ArgumentParser(description="Align one deterministic shard of single-chain CaV1.2 AlphaFold structures to the common 8WE6 frame.")
