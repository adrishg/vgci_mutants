...
from cav12_ensemble_rmsf.workflow import inspect_inputs

def main() -> None:
    parser = argparse.ArgumentParser(description="Inspect CaV1.2 AlphaFold ensemble inputs and build the complete model manifest.")
