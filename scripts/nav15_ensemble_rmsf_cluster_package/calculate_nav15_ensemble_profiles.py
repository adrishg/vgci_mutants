...
from nav15_ensemble_rmsf.workflow import calculate_profiles

def main() -> None:
    parser = argparse.ArgumentParser(description="Calculate full-protein Nav1.5 ensemble RMSF and deviations to all experimental references.")
