#!/usr/bin/env python3
"""Calculate sequence-verified Nav1.5 WT IFM-latching distances."""
...
parser.add_argument("--folder-path", required=True, help="Folder containing WT PDB files.")
...
# canonical F1486/N1659/N1765 -> model F1170/N1343/N1449.
residue_pairs_shortest = [
    ("PHE", 1170, "ASN", 1343),  # IFM1
    ("PHE", 1170, "ASN", 1449),  # IFM2
]
residue_pairs_ca = residue_pairs_shortest

print(f"--- Starting WT PDB analysis from: {folder_path} ---")
...
for pdb_file_name in pdb_files:
    ...
    print(f"Calculating WT IFM distances: {pdb_file_name}")
